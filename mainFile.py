...
plt.figure(figsize=(12, 6))
grad_df = df[df['Age_group'] == 'All ages'][['District', 'Persons_Graduate']].sort_values('Persons_Graduate', ascending=False).head(10)
sns.barplot(x='District', y='Persons_Graduate', data=grad_df)
plt.title('Top 10 Districts by Graduate Population')
